...
\judgment[``Head'' reduction (pure)]{\expr_1, \pstate_1 \hstep [\vec\obs] \expr_2, \pstate_2, \vec\expr}
...
\begin{figure}
\judgment[``Head'' reduction (impure)]{\expr_1, \pstate_1 \hstep [\vec\obs] \expr_2, \pstate_2, \vec\expr}
\newcommand\alignheader{\kern-30ex}
\begin{align*}
